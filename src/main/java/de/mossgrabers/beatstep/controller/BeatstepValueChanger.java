 ...
 */
public class BeatstepValueChanger extends DefaultValueChanger
{
    /**
     * Constructor.
     *
     ...
     */
    public BeatstepValueChanger (final int upperBound, final int fractionValue, final double slowFractionValue)
    {
