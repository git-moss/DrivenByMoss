...
public class ClipMode extends AbstractTrackMode
{
    ...
    public void updateDisplay2 (final IGraphicDisplay display)
    {
        ...
        final boolean isPinned = canPin && clip instanceof INoteClip noteClip && noteClip.isPinned ();
    ...
    public void onSecondRow (final int index, final ButtonEvent event)
    {
        ...
        {
            final IClip clip = this.model.getCursorClip ();
            if (clip instanceof INoteClip noteClip)
    ...
    public int getButtonColor (final ButtonID buttonID)
    {
        ...
        if (index >= 0)
        {
            if (index == 0)
            {
                ...
                final IClip clip = this.model.getCursorClip ();
                final boolean isPinned = clip instanceof INoteClip noteClip && noteClip.isPinned ();
