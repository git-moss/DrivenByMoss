...
public class SendMode extends AbstractTrackMode
{
    ...
    public void updateDisplay2 (final IGraphicDisplay display)
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            display.addSendsElement (pair.getKey (), pair.getValue ().booleanValue (), t.doesExist () ? t.getName () : "", updateType (t), t.getColor (), t.isSelected (), sendData, false, t.isActivated (), t.isActivated ());
        }
    }
}