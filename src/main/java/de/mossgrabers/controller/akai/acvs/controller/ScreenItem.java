...
public enum ScreenItem
{
    ...
    MPC_KNOBSTYLE1_COLOR(0x0D, true, 16),
    MPC_KNOBSTYLE2_COLOR(0x0D, true, 17),
    MPC_KNOBSTYLE3_COLOR(0x0D, true, 18),
    MPC_KNOBSTYLE4_COLOR(0x0D, true, 19),
    MPC_KNOBSTYLE5_COLOR(0x0D, true, 20),
    MPC_KNOBSTYLE6_COLOR(0x0D, true, 21),
    MPC_KNOBSTYLE7_COLOR(0x0D, true, 22),
    MPC_KNOBSTYLE8_COLOR(0x0D, true, 23);
