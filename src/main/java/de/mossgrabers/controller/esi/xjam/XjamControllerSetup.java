...
public class XjamControllerSetup extends AbstractControllerSetup<XjamControlSurface, XjamConfiguration>
{
    ...
    protected void registerTriggerCommands ()
    {
        ...
        // this.addButton (ButtonID.SCALES, "Scales", new ScaleButtonCommand (this.model, surface),
        // CHANNEL, XjamControlSurface.BUTTON_SCALE, this.configuration::isScaleIsActive);
        // this.addButton (ButtonID.METRONOME, "Metronome", new MetronomeCommand<> (this.model,
        // surface, false), CHANNEL, XjamControlSurface.BUTTON_ARP, () -> surface.isShiftPressed ()
        // && t.isMetronomeTicksOn () || !surface.isShiftPressed () && t.isMetronomeOn ());
        //
        // this.addButton (ButtonID.PLAY, "PLAY", new XjamPlayCommand (this.model, surface),
        // CHANNEL, XjamControlSurface.BUTTON_PLAY, t::isPlaying);
        // this.addButton (ButtonID.RECORD, "REC", new RecordCommand<> (this.model, surface),
        // CHANNEL, XjamControlSurface.BUTTON_REC, t::isRecording);
        // this.addButton (ButtonID.STOP, "STOP", new StopCommand<> (this.model, surface), CHANNEL,
        // XjamControlSurface.BUTTON_STOP, () -> !t.isPlaying ());
        // this.addButton (ButtonID.REWIND, "RWD", new WindCommand<> (this.model, surface, false),
        // CHANNEL, XjamControlSurface.BUTTON_RWD, () -> surface.isPressed (ButtonID.REWIND));
        // this.addButton (ButtonID.FORWARD, "FFW", new WindCommand<> (this.model, surface, true),
        // CHANNEL, XjamControlSurface.BUTTON_FWD, () -> surface.isPressed (ButtonID.FORWARD));
        // this.addButton (ButtonID.LOOP, "LOOP", new ToggleLoopCommand<> (this.model, surface),
        // CHANNEL, XjamControlSurface.BUTTON_LOOP, t::isLoop);
        //
        // this.addButton (ButtonID.PAGE_LEFT, "Left", new ModeMultiSelectCommand<> (this.model,
        // surface, Modes.DEVICE_PARAMS, Modes.VOLUME, Modes.TRACK), CHANNEL,
        // XjamControlSurface.BUTTON_PAGE_LEFT);
        // this.addButton (ButtonID.PAGE_RIGHT, "Right", new ModeMultiSelectCommand<> (this.model,
        // surface, Modes.TRACK, Modes.VOLUME, Modes.DEVICE_PARAMS), CHANNEL,
        // XjamControlSurface.BUTTON_PAGE_RIGHT);
        //
        // this.addButton (ButtonID.MASTERTRACK, "Encoder", new MainEncoderButtonCommand
        // (this.model, surface), CHANNEL, XjamControlSurface.BUTTON_MAIN_ENCODER);
        //
        // final XjamCursorCommand commandDown = new XjamCursorCommand (Direction.DOWN, this.model,
        // surface);
        // this.addButton (ButtonID.ARROW_DOWN, "Down", commandDown, CHANNEL,
        // XjamControlSurface.BUTTON_NAVIGATE_DOWN, commandDown::canScroll);
        // final XjamCursorCommand commandUp = new XjamCursorCommand (Direction.UP, this.model,
        // surface);
        // this.addButton (ButtonID.ARROW_UP, "Up", commandUp, CHANNEL,
        // XjamControlSurface.BUTTON_NAVIGATE_UP, commandUp::canScroll);
        // final XjamCursorCommand commandLeft = new XjamCursorCommand (Direction.LEFT, this.model,
        // surface);
        // this.addButton (ButtonID.ARROW_LEFT, "Left", commandLeft, CHANNEL,
        // XjamControlSurface.BUTTON_NAVIGATE_LEFT, commandLeft::canScroll);
        // final XjamCursorCommand commandRight = new XjamCursorCommand (Direction.RIGHT,
        // this.model, surface);
        // this.addButton (ButtonID.ARROW_RIGHT, "Right", commandRight, CHANNEL,
        // XjamControlSurface.BUTTON_NAVIGATE_RIGHT, commandRight::canScroll);
        //
        // this.addButton (ButtonID.MUTE, "Back", new BackButtonCommand (this.model, surface),
        // CHANNEL, XjamControlSurface.BUTTON_BACK, () -> this.getModeColor (ButtonID.MUTE));
        // this.addButton (ButtonID.SOLO, "Enter", new EnterButtonCommand (this.model, surface),
        // CHANNEL, XjamControlSurface.BUTTON_ENTER, () -> this.getModeColor (ButtonID.SOLO));
        //
        // this.addButton (ButtonID.BROWSE, "Browse", new BrowserCommand<> (this.model, surface,
        // ButtonID.SHIFT, null), CHANNEL, XjamControlSurface.BUTTON_BROWSE, () -> this.getModeColor
        // (ButtonID.BROWSE));
        // this.addButton (ButtonID.SHIFT, "Shift", NopCommand.INSTANCE, CHANNEL,
        // XjamControlSurface.BUTTON_SHIFT);
    }
    ...
    protected void registerContinuousCommands ()
    {
        ...
        // for (int i = 0; i < 8; i++)
        // {
        // final IHwRelativeKnob knob = this.addRelativeKnob (ContinuousID.get (ContinuousID.KNOB1,
        // i), "Knob " + (i + 1), new KnobRowModeCommand<> (i, this.model, surface), BindType.CC,
        // CHANNEL, XjamControlSurface.ENCODER_1 + i);
        // knob.bindTouch (new KnobRowTouchModeCommand<> (i, this.model, surface), input,
        // BindType.CC, CHANNEL, XjamControlSurface.TOUCH_ENCODER_1 + i);
        // knob.setIndexInGroup (i);
        // }
        //
        // this.addRelativeKnob (ContinuousID.MASTER_KNOB, "Master", new MainEncoderCommand
        // (this.model, surface), BindType.CC, CHANNEL, XjamControlSurface.MAIN_ENCODER);
    }
