...
import de.mossgrabers.controller.fire.view.PolySequencerView;
import de.mossgrabers.controller.fire.view.SequencerView;
...
public class FireControllerSetup extends AbstractControllerSetup<FireControlSurface, FireConfiguration>
{
    ...
    protected void createModes ()
    {
        ...
        modeManager.registerMode (Modes.DEVICE_LAYER, new FireLayerMode (surface, this.model));
