...
import de.mossgrabers.controller.kontrol.usb.mkii.mode.BaseMode;
...
public abstract class AbstractTrackMode extends BaseMode
{
     ...
     */
    public AbstractTrackMode (final Kontrol2ControlSurface surface, final IModel model)
    {
        super (surface, model);
    ...
    public void onFirstRow (final int index, final ButtonEvent event)
    {
        ...
        {
            // TODO
            // if (this.surface.isPressed (Kontrol2ControlSurface.BUTTON_DUPLICATE))
            // {
            // this.surface.setButtonConsumed (Kontrol2ControlSurface.BUTTON_DUPLICATE);
            // track.duplicate ();
            // return;
            // }
            //
            // if (this.surface.isPressed (Kontrol2ControlSurface.BUTTON_DELETE))
            // {
            // this.surface.setButtonConsumed (Kontrol2ControlSurface.BUTTON_DELETE);
            // track.remove ();
            // return;
            // }
            //
            // if (this.surface.isPressed (Kontrol2ControlSurface.BUTTON_CLIP_STOP))
            // {
            // this.surface.setButtonConsumed (Kontrol2ControlSurface.BUTTON_CLIP_STOP);
            // track.stop ();
            // return;
            // }

            if (this.surface.isPressed (Kontrol2ControlSurface.BUTTON_REC))
            {
                this.surface.setButtonConsumed (Kontrol2ControlSurface.BUTTON_REC);
                track.toggleRecArm ();
                return;
            }
        ...
        // this.surface.setButtonConsumed (Kontrol2ControlSurface.BUTTON_ROW1_1 + index);
        // }
    }
    ...
    public void onSecondRow (final int index, final ButtonEvent event)
    {
        ...
        // modeManager.setActiveMode (Integer.valueOf (Modes.MODE_SEND1.intValue () +
        // (config.isSendsAreToggled () ? 4 : 0)));
        // }
        // break;
        //
        // case 7:
    ...
    public void updateSecondRow ()
    {
        ...
        // this.surface.updateButton (102 + i, track.doesExist () && track.isPlaying () ?
        // Kontrol2Colors.KONTROL2_COLOR_RED_HI : Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // }
        // return;
        // }
        //
        ...
        //
        // final ModeManager modeManager = this.surface.getModeManager ();
        // this.surface.updateButton (102, modeManager.isActiveOrTempMode (Modes.MODE_VOLUME) ?
        // Kontrol2Colors.KONTROL2_COLOR2_WHITE : Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // this.surface.updateButton (103, modeManager.isActiveOrTempMode (Modes.MODE_PAN) ?
        // Kontrol2Colors.KONTROL2_COLOR2_WHITE : Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // this.surface.updateButton (104, modeManager.isActiveOrTempMode (Modes.MODE_CROSSFADER) ?
        // Kontrol2Colors.KONTROL2_COLOR2_WHITE : Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // this.surface.updateButton (105, Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // final boolean sendsAreToggled = config.isSendsAreToggled ();
        // this.surface.updateButton (106, modeManager.isActiveOrTempMode (sendsAreToggled ?
        // Modes.MODE_SEND5 : Modes.MODE_SEND1) ? Kontrol2Colors.KONTROL2_COLOR2_WHITE :
        // Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // this.surface.updateButton (107, modeManager.isActiveOrTempMode (sendsAreToggled ?
        // Modes.MODE_SEND6 : Modes.MODE_SEND2) ? Kontrol2Colors.KONTROL2_COLOR2_WHITE :
        // Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // this.surface.updateButton (108, modeManager.isActiveOrTempMode (sendsAreToggled ?
        // Modes.MODE_SEND7 : Modes.MODE_SEND3) ? Kontrol2Colors.KONTROL2_COLOR2_WHITE :
        // Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // this.surface.updateButton (109, tb.hasParent () ? Kontrol2Colors.KONTROL2_COLOR2_WHITE :
        // Kontrol2Colors.KONTROL2_COLOR_BLACK);
        // return;
        // }
        //
        ...
        //
        // int color = Kontrol2Colors.PUSH1_COLOR_BLACK;
        // if (t.doesExist ())
        // {
        // if (muteState)
        // {
        // if (!t.isMute ())
        // color = Kontrol2Colors.PUSH1_COLOR2_YELLOW_HI;
        // }
        // else
        // color = t.isSolo () ? Kontrol2Colors.PUSH1_COLOR2_BLUE_HI :
        // Kontrol2Colors.PUSH1_COLOR2_GREY_LO;
        // }
        //
    ...
    // {
    // if (!t.doesExist ())
    // return Kontrol2Colors.KONTROL2_COLOR_BLACK;
    //
    // if (muteState)
    // {
    // if (t.isMute ())
    // return Kontrol2Colors.KONTROL2_COLOR2_AMBER_LO;
    // }
    // else if (t.isSolo ())
    // return Kontrol2Colors.KONTROL2_COLOR2_YELLOW_HI;
    //
    // return Kontrol2Colors.KONTROL2_COLOR_BLACK;
    // }
    ...
    protected int getTrackButtonColor (final ITrack track)
    {
        ...
        if (track.isRecArm ())
            return isSel ? Kontrol2Colors.KONTROL2_COLOR_RED_HI : Kontrol2Colors.KONTROL2_COLOR_RED_LO;

        return isSel ? Kontrol2Colors.KONTROL2_COLOR_ORANGE_HI : Kontrol2Colors.KONTROL2_COLOR_YELLOW_LO;
    }
    ...
    protected void updateTrackMenu (final int selectedMenu)
    {
        ...
        // this.menu.get (2).set (config.isDisplayCrossfader () ? "Crossfader" : " ",
        // Boolean.valueOf (selectedMenu - 1 == 2));
        //
        // if (this.model.isEffectTrackBankActive ())
        // {
        ...
        // final boolean sendsAreToggled = config.isSendsAreToggled ();
        //
        // this.menu.get (3).set (sendsAreToggled ? "Sends 5-8" : "Sends 1-4", Boolean.valueOf
        // (sendsAreToggled));
        //
        // final ITrackBank tb = this.model.getCurrentTrackBank ();
        ...
        // this.menu.get (4 + i).set (sendName.isEmpty () ? " " : sendName, Boolean.valueOf (4 + i
        // == selectedMenu - 1));
        // }
        //
        // if (isShiftPressed)
