...
/**
 * The Punch Out command. Toggles punch out.
 *
 * @author Jürgen Moßgraber
 */
public class RotoControlPunchOutCommand extends AbstractTriggerCommand<RotoControlControlSurface, RotoControlConfiguration>
{
    /**
     * Constructor.
     *
     ...
     */
    public RotoControlPunchOutCommand (final IModel model, final RotoControlControlSurface surface)
    {
        super (model, surface);
    }
