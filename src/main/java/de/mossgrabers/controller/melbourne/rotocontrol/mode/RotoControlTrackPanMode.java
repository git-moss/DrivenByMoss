...
/**
 * The panning mode. The knobs control the panning of the tracks on the current track page. Updates
 * all relevant parameters for the mode on the ROTO CONTROl.
 *
 * @author Jürgen Moßgraber
 */
public class RotoControlTrackPanMode extends TrackPanMode<RotoControlControlSurface, RotoControlConfiguration> implements RotoControlMode
{
     ...
     */
    public RotoControlTrackPanMode (final RotoControlControlSurface surface, final IModel model)
    {
