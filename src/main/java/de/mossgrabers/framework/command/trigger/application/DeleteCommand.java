 ...
 */
public class DeleteCommand<S extends IControlSurface<C>, C extends Configuration> extends AbstractTriggerCommand<S, C>
{
    /**
     * Constructor.
     *
     ...
     */
    public DeleteCommand (final IModel model, final S surface)
    {
        super (model, surface);
    }
