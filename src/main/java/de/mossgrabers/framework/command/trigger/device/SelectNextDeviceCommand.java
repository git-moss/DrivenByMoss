 ...
 */
public class SelectNextDeviceCommand<S extends IControlSurface<C>, C extends Configuration> extends AbstractTriggerCommand<S, C>
{
     ...
     */
    public SelectNextDeviceCommand (final IModel model, final S surface)
    {
        super (model, surface);
