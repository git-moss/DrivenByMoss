 ...
 */
public class VolumeParameterProvider extends AbstractChannelParameterProvider
{
    /**
     * Constructor.
     *
     ...
     */
    public VolumeParameterProvider (final IChannelBank<? extends IChannel> bank)
    {
        super (bank);
    }
    ...
    {
        return this.getChannel (index).getVolumeParameter ();
    }
}
